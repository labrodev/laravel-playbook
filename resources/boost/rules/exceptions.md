...
- No `Illuminate\Validation\ValidationException` thrown or constructed outside the Data validation layer — business gates throw their own named exception class.
